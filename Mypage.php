  	...
  	<a class="menu" id="menu"><span>MENU</span></a>
		<div class="panel">   
			<ul>
				...
				<li class="active"><a href="Mypage.php"><strong>マイページ</strong><span>Mypage</span></a></li>
				<li><a href="Simulationcp.php"><strong>シミュレーション</strong><span>Simulationcp</span></a></li>
				<li><a href="Questionnaire-Contact.php"><strong>アンケート/お問い合わせ</strong><span>Questionnaire/Contact</span></a></li>
				</ul> 
    </div>
	</div> 
</nav>
  ...
  <section id="main">
    ...
    <section class="content">
		...
		<article>
			...
			<a href="https:" target="_blank" rel="noopener noreferrer">アンケートページへ移動</a>
		</article>
	</section>
